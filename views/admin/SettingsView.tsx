...
const SettingsView: React.FC<SettingsViewProps> = ({ appContext, authContext }) => {
    ...
    const handleHardReset = async () => {
        if (!window.confirm("Isso irá limpar o cache local de todos os navegadores para garantir que o código mais recente seja carregado. Você será desconectado. Continuar?")) return;
        ...
        localStorage.clear();
        // FIX: Removed boolean argument from window.location.reload() to fix TypeScript error "Expected 0 arguments, but got 1".
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                    <Button variant="secondary" onClick={handleHardReset} title="Limpa o cache e força o carregamento da versão mais recente">
            ...
            <div className="mt-8 pt-4 border-t dark:border-gray-800 text-center">
                <p className="text-[10px] text-gray-400 uppercase tracking-widest font-black">
                    Piscina Limpa v38.0 - Build: {new Date().toLocaleDateString()}
                </p>
            </div>
